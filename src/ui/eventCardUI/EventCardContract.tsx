...
export default function EventCardContract({
  contract,
}: EventCardContractProps) {
      ...
      <div className="flex prices gap-2">
        <div className="flex flex-col items-center">
          ...
          <p className="text-grey-300 font-bold text-xs p-1">
            {mockOffersData[0]
              ? quantityFormatter(
                  mockOffersData[0].quantity,
                  mockOffersData[0].price
                )
              : null}
          </p>
        </div>
        <div className="flex flex-col items-center ">
          ...
          <p className="text-grey-300 font-bold text-xs p-1">
            {mockBidsData[0]
              ? quantityFormatter(
                  mockBidsData[0].quantity,
                  mockBidsData[0].price
                )
              : null}
          </p>
        </div>
